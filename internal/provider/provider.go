...
func (p *hashicupsProvider) Configure(ctx context.Context, req provider.ConfigureRequest, resp *provider.ConfigureResponse) {
	...
	// If user provided a configuration value for any of the attributes,
	...
	if config.Host.IsUnknown() {
		resp.Diagnostics.AddAttributeError(
			...
			"The provider cannot create the HashiCups API client as there is an unknown configuration for the HashiCups API host."+
